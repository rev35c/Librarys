...
function Library.__init()
    ...
    local function onInputBegan(input, gameProcessed)
        ...
        if input.KeyCode == Enum.KeyCode.End or input.KeyCode == Enum.KeyCode.End then
            ctrlDown = true
    ...
    function Tab:update_sections(b)
        b.left_section.Visible = true
        b.right_section.Visible = true
        
        for _, object in next, Container:GetChildren() do
            if not object.Name:find("Section") then
                return
            end
            
            if object == b.left_section then 
                
            end
            
            if object == b.right_section then
	...
	function Tab:open_tab(bebra)
	    Tab:update_sections({
	        left_section = bebra.left_section,
	        right_section = bebra.right_section
	    })
	    
	    TweenService:Create(bebra.tab.Fill, TweenInfo.new(0.4), {
	        BackgroundTransparency = 0
	    }):Play()
	    
	    TweenService:Create(bebra.tab.Glow, TweenInfo.new(0.4), {
	        ImageTransparency = 0
	    }):Play()
	    
	    TweenService:Create(bebra.tab.TextLabel, TweenInfo.new(0.4), {
	        TextTransparency = 0
	    }):Play()
	    
	    TweenService:Create(bebra.tab.Logo, TweenInfo.new(0.4), {
	        ImageTransparency = 0
	    }):Play()
	    
	    for _, object in next, tabs:GetChildren() do
	        if object.Name ~= 'Tab' then
	            return
	        end
	        
	        if object == bebra.tab then
    ...
    function Tab:create_tab(name)
        ...
        left_section.ScrollingDirection = "Y"
        ...
        right_section.ScrollingDirection = "Y"
		...
		function Module:create_title(self)
		...
		function Module:enable_toggle(self)
		...
		function Module:disable_toggle(self)
		    TweenService:Create(self.Checkbox.Fill, TweenInfo.new(0.4), {
		        BackgroundTransparency = 1
		        }):Play()
		...
		function Module:update_toggle(self)
		    if self.state then
		...
		function Module:create_toggle(self)
		    local section = self.section == 'left' and left_section or right_section
		    ...
		    if not Library.Flags[self.flag] then
		        Library.Flags[self.flag] = enabled
		    end
		...
		function Module:create_description_toggle(self)
		    local section = self.section == 'left' and left_section or right_section
		...
		function Module:create_paragraph(self)
		    local section = self.section == 'left' and left_section or right_section
		...
		function Module:create_button(self)
		    local section = self.section == 'left' and left_section or right_section
        ...
        function Module:update_slider(self)
		...
		function Module:slider_loop(self)
		...
		function Module:create_slider(self)
		    local drag = false
		    local section = self.section == 'left' and left_section or right_section
		...
		function Module:create_dropdown(self)
		    local section = self.section == 'left' and left_section or right_section
		    local list_size = 6
		    local open = false
			...
			function Dropdown:update(self)
			    ...
			    for _, value in next, self.options do
        ...
        function Module:create_image(self)
            local section = self.section == 'left' and left_section or right_section
        ...
        function Module:create_textbox(self)
            local section = self.section == 'left' and left_section or right_section
            local Textbox = {}
		...
		function Module:create_keybind(self)
		    local section = self.section == 'left' and left_section or right_section
